...
| ---- | ------------------------------------------------------------ | :-----: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| 2024.07 | **Revisiting Character-level Adversarial Attacks for Language Models** |   arXiv    | [link](https://arxiv.org/abs/2405.04346)  |                                             -                |
...
| 2024.06 | **Improved Techniques for Optimization-Based Jailbreaking on Large Language Models (I-GCG)** |   arXiv   | [link](https://arxiv.org/pdf/2402.08679)  |                              [link](https://github.com/jiaxiaojunQAQ/I-GCG)                               |
